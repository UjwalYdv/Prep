...
- Use and intuition behind **LSTM networks** (from one of my ML projects) → [LSTM Networks Explained – GeeksforGeeks](https://www.geeksforgeeks.org/machine-learning/lstm-networks/)
- **DBMS fundamentals**, mainly normalization and indexing → [Normalization in DBMS – GeeksforGeeks](https://www.geeksforgeeks.org/dbms/introduction-of-database-normalization/)
...
- [Top HR and Leadership Questions – GeeksforGeeks](https://www.geeksforgeeks.org/hr/hr-interview-questions/)
