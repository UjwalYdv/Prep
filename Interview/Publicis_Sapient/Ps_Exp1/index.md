...
The interview process at **Publicis Sapient** was conducted in **two elimination rounds**, focusing on a balance between **technical depth** and **cultural fit**.  
The overall process was straightforward, with strong emphasis on **resume projects**, **practical understanding**, and **alignment with company values**.

---

## 💻 Round 1 – Technical / Project Interview
...
- Example:
  - I mentioned **React**
  - Follow-up questions were asked immediately on **React Hooks**
...
- While I was not explicitly asked to explain the **entire codebase**,  
  ...
  - Be comfortable explaining design decisions
...
## 💬 Round 2 – HR / Core Values Interview
...
- **Extracurricular activities**
  - Clubs I was part of
  - My role and learning experiences

---

### 🎯 Key Strategy (Very Important)

Almost **every answer** in this round needed to be framed around  
...
- **Frame your answers smartly:**  
  Connect your strengths, weaknesses, situations, and extracurriculars to the company’s values.
- **Prepare basics:**  
  Expect at least one **easy DSA question**.
