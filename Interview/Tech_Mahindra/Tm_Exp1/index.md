...
I participated in the **on-campus recruitment process for the Technorise Summer Internship at Tech Mahindra**.  
The process consisted of **multiple rounds**, evaluating **coding skills, aptitude, communication ability, project understanding, and HR fit**.
...
- In-depth discussion on my **projects**
  ...
  - Key learnings
- One **simple string-based coding question**
...
Overall, the experience was **smooth and well-structured**.  
The interview process tested **basics, consistency, and communication**, rather than very advanced topics.
